	...
	<div id="main-content" style="width: 75%; margin: 0 auto; ">
		<div class="content-box">
			...
			<div class="content-box-header">
				<h3>学院编辑:<?php echo ($academy['academyname']); ?></h3>
			...
			<div class="content-box-content">
				<form
					action="<?php echo U('SystemSetting/editAcademySubmit','academyid=' . $academy['academyid']);?>"
					method="post">
					<fieldset>
						...
						<p>
							<label>学院名称</label> <input
								...
								id="medium-input" name="academyname"
								value="<?php echo ($academy['academyname']); ?>" /> <br />
						</p>
						<p>
							<label>学院描述</label> <input
								class="text-input medium-input datepicker" type="text"
								id="medium-input" name="academydescription"
								value="<?php echo ($academy['academydescription']); ?>" /> <br />
						</p>
